...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "4. In your code, use the DUAL-TAG pattern for EVERY uploaded image. This makes\n"
        "   previews work (placeholder visible) while deplixo_deploy auto-swaps to the real image:\n\n"
        "     <div class=\"deplixo-img-placeholder\" data-for=\"hero\" style=\"width:100%;height:300px;\n"
        "       background:linear-gradient(135deg,#8b7355,#c4a882);display:flex;align-items:center;\n"
        "       justify-content:center;color:#fff;font-size:1.1em;border-radius:12px;text-align:center;\n"
        "       padding:20px\">Your photo will appear here when deployed</div>\n"
        "     <img class=\"deplixo-img-real\" data-for=\"hero\" src=\"https://cdn.deplixo.com/...\"\n"
        "       style=\"display:none\" alt=\"Whiskers\">\n\n"
        "   Rules for the dual-tag pattern:\n"
        "   - The `data-for` value must match between placeholder and img (use a short label)\n"
        "   - The placeholder should be sized to roughly match the intended image dimensions\n"
        "   - Pick placeholder background colors that complement the app's design\n"
        "   - The real img MUST have class=\"deplixo-img-real\" and style=\"display:none\"\n"
        "   - The placeholder MUST have class=\"deplixo-img-placeholder\"\n"
        "   - deplixo_deploy automatically removes placeholders and shows real images\n"
        "   - When you receive code back from deplixo_read_source, the dual-tag pattern will\n"
        "     be restored so previews still work during editing\n\n"
