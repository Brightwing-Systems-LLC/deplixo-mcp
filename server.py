...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "4. Use the CDN URLs in the app code (<img src=\"https://cdn...\">)\n"
        "5. For the in-chat preview: the sandbox blocks external URLs, so CDN images won't\n"
        "   load. Use a styled placeholder instead (e.g., a colored div with the image\n"
        "   description as text). Tell the user the placeholder will become their real\n"
        "   image in the deployed version. You CANNOT extract image bytes from conversation\n"
        "   attachments to create base64 data URIs — do not attempt this.\n\n"
