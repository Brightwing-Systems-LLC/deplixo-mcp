...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "5. Do NOT show an in-chat preview/artifact with CDN image URLs — the sandbox blocks\n"
        "   external network requests so images won't load. Instead, skip the preview and\n"
        "   deploy directly. Tell the user: \"The preview can't show external images, but\n"
        "   they'll work perfectly in the deployed app.\"\n\n"
