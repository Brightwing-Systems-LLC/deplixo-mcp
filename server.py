...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "4. Build the code with CDN URLs (<img src=\"https://cdn...\">)\n"
        "5. Do NOT show an in-chat preview artifact — the sandbox blocks external URLs\n"
        "   so the images will appear broken. Instead, deploy directly to Deplixo.\n"
        "   The activation page has a live preview where images work. Tell the user:\n"
        "   \"I'm deploying directly since the in-chat preview can't display uploaded\n"
        "   images. You'll see everything including your photo on the live site.\"\n\n"
